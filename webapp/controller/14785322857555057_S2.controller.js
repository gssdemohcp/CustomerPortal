sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14785322857555057_S2", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("14785322857555057_S2").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		},
		...
		_onRowPress1: function() {
			var oBindingContext = this.getView().getBindingContext();
			this.doNavigate("14785369375718072_S4", oBindingContext);
		}
	});
}, /* bExport= */ true);