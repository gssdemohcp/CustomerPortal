sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14785384963975306_S5", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("14785384963975306_S5").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		},
		...
		_onRowPress2: function() {
			var oBindingContext = this.getView().getBindingContext();
			this.doNavigate("14786139239811909_S6", oBindingContext);
		}
	});
}, /* bExport= */ true);